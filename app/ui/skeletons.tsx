...
export function CustomersMobileSkeleton() {
  return (
    <div className="mb-2 w-full rounded-md bg-white p-4">
      <div className="flex gap-2 flex-col border-b border-gray-100 pb-4">
        <div className="flex items-center">
          <div className="mr-2 h-8 w-8 rounded-full bg-gray-100"></div>
          <div className="h-6 flex-1 rounded bg-gray-100"></div>
        </div>
        <div className="h-6 rounded bg-gray-100"></div>
      </div>
      <div className="flex w-full pt-4 border-b border-gray-100 pb-4">
